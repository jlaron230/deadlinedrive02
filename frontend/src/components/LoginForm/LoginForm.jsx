          ...
          >
            <Form className="flex flex-col">
              ...
              <div className="text-left text-gray-500 text-xs mb-4">
                Votre mot de passe doit être une combinaison d'au moins 6
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <a href="/passwordRecovery" className="text-caramel">
                  Mot de passe oublié?
                </a>
              </div>
              ...
              <button
                type="submit"
                className="bg-butterscotch text-white py-2 rounded"
              >
                Connexion
              </button>

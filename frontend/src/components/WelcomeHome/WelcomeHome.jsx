...
const WelcomeHome = () => {
    return (
        <main className="md:min-h-[87vh] flex flex-col p-2 items-center justify-center">
            <h1 className=" p-8 font-semibold text-xl flex justify-center">Bienvenue sur Deadline Drive, votre allié pour rester motiver</h1>

                <article className='flex flex-row flex-wrap p-4 m-2 '>
                
                    <div className="flex-1 basis-80">
                    <img src="src\assets\image-live-work.webp" alt=" Image d'un mur avec les mots : Live, work and create " className=" rounded-md h-max w-full	"/>
                    </div>

                    <div className=" space-y-4 ml-6 flex-1 basis-80  text-1xl text-grey-600">
                        <p>
